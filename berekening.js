// berekening.js — Mestnormen volgens RVO (2025)
const normen = {
  mais: {
...
document.getElementById('mestForm').addEventListener('submit', e => {
  e.preventDefault();
  const ha = parseFloat(document.getElementById('hectare').value);
