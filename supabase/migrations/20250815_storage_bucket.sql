-- Maak bucket (idempotent)
insert into storage.buckets (id, name, public)
values ('mest-analyses','mest-analyses', false)
on conflict (id) do nothing;

-- Policies voor alleen deze bucket
