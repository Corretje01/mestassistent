...
function renderParcelList() {
  ...
  parcels.forEach(p => {
    ...
    div.innerHTML = `
      ...
      <div class="form-group"><label>Kad. PerceelID</label><input readonly value="${p.perceelId || ''}"></div>
      ...
      <div class="form-group"><label>Teelt</label><select class="teelt">
      ...
      <div class="form-group"><label>Derogatie</label><select class="derogatie">
...
map.on('click', async e => {
  ...
  try {
    ...
    if (!baseCat||baseCat==='Onbekend') try {
